# Contributing to Analytics Service
...
```bash
git clone https://github.com/YOUR_USERNAME/analytics_service.git
...
```bash
git remote add upstream https://github.com/mission-engadi/analytics_service.git
```
